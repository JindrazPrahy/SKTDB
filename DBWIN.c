...
printf("Narozd%cl od v%ct%ciny jin%cch hern%ck%c se zde vyskytuj%c hry      '  {____}  '  #ID --> hashtag a %c%cslo uk%c%ce konkr%ctní hru    \n", ii, ie, sz, yy, ii, uk, ii, cz, ii, aa, zs, ee);
...
int filtr(int bypass){ /* funkce na vytvoření filtrovaného seznamu    ZNAK FUNKCE FILTR */
	...
	if(bypass == 0){
FILTROVANI:
printf("Zadejte va%ce po%cadovan%c vyhled%cvac%c krit%cria a potom 'hledat' (nebo help pro zobrazen%c mo%cn%cch kritérií):\n", sz, zs, ee, aa, ii, ee, ii, zs, yy);
...
printf("vy%cerp%cvaj%cc%c - b%cha%cky (beh), brut%cln%c a n%cro%cn%c (b), p%cem%c%clec%c (m), pohodov%c (p), speciální (sp) \n", cz, aa, ii, ii, ie, cz, aa, ii, aa, cz, ee, rz, yy, sz, ii, ee);
...
printf("se nenudili. Koment%c%c z role sportovn%cho koment%ctora m%c%ce b%ct vtipný. \n", aa, rz, ii, aa, uk, zs, yy);
printf("Zde pi%cte p%c%ckazy: \n", sz, rz, ii);
	}
...
printf("-Antigrav. pras%ctko: sna%c%c se b%ct co nejv%cš\n", aa, zs, ii, yy, yy);
...
printf("Jeden %clov%ck m%c%ce m%ct i v%cce rol%c. Role se nesm%c nikomu %c%ckat.          dokud se nezasměje  \n", cz, ie, uk, zs, ii, ii, ii, ii, rz, ii);
printf("POZN.: Lid%c se mohou p%c%cli%c v%c%ct do sv%c role. P%cipravte se proto       -D%ct%c: zlob%c a za ka%cdou cenu nesm%c dostat dárek\n", ee, rz, ii, sz, zs, ii, ee, rz, ii, ie, ii, zs, ii);
printf("na p%c%cpadn%c pranice. Tak%c si nechte po h%ce %cas na %cklid.              ", rz, ii, ee, ee, rz, cz, uu);
printf("-Santa: d%cv%c d%crky lidem a mus%c 1 d%ct i d%ctěti\n", aa, aa, aa, ii, aa, ii);
printf("Role m%c%cete rozd%cvat n%chodn%c, ale p%c%cpadn%c v%cb%cr trochu ovlivněte.    ", uk, zs, aa, aa, ie, rz, ii, ie, yy, ie);
...
printf("kdy%c neposlechnou, dohl%cdn%cte, aby ud%clali 10 kliků\n", zs, ee, ie, ie);
printf("Zde pi%cte p%c%ckazy: \n", sz, rz, ii);
	}
...
printf("PRAVIDLA: Hr%c%ci se rozd%cl%c do dvou stejn%c po%cetn%cch t%cm%c. P%cipravte hrací pole, ", aa, cz, ie, ii, ie, cz, yy, yy, uk, rz);
...
printf("toto n%ckter%cmu z t%cm%c povede, ukon%c%c se kolo, t%cm\n dostane bod a v%ce se vr%ct%c zp%ct do p%cvodního stavu. ", ie, ee, yy, uk, cz, ii, yy, sz, aa, ii, ie, uk);
printf("Proti sebr%cn%c p%cedm%ctu se t%cm m%c%ce br%cnit tak,\n %ce pokud se n%ckter%c z hr%c%c%c nach%cz%c na poli cizího týmu, ", aa, ii, rz, ie, yy, uk, zs, aa, zs, ie, yy, aa, cz, uk, aa, ii);
printf("m%c%ce ho druh%c t%cm zmrazit dotykem. %clov%ck,\n kter%cho zmrazili, se nesm%c h%cbat dokud ho nerozmraz%c dotyk hr%c%ce ze sv%cho týmu. \n", uk, zs, yy, yy, CZ, ie, ee, ii, yy, ii, aa, cz, ee);
...
printf("REKVIZITY: Stoli%cka, %c%ctek na zav%cz%cn%c o%c%c, mikina na vytvo%cen%c palcátu\n", cz, sz, aa, aa, aa, ii, cz, ii, rz, ii);
printf("PRAVIDLA: Ur%c%c se jeden hr%c%c, jeho%c %ckol se stane reprezentovat %clov%cka. Ostatn%c lid%c reprezentují\n ", cz, ii, aa, cz, zs, uu, cz, ie, ii, ee);
printf("kom%cry. %clov%ck si sedne na stoli%cku doprost%ced m%cstnosti, do ruky dostane zav%czanou mikinu %ci %cátek,\n ", aa, CZ, ie, cz, rz, ii, aa, cz, sz);
...
printf("%clov%cku. To provedou tak, %ce se ho dotknou a pot%c se dotknou st%cny (t%cm z%cskaj%c bod). %clov%ck se však\n ", cz, ie, zs, ee, ie, ii, ii, ii, CZ, ie);
printf("oh%cn%c novinami a pokud n%cjak%cho kom%cra zas%chne, je do konce kola vy%cazen. C%clem kom%crů je\n ", aa, ii, ie, ee, aa, aa, rz, ii, aa);
...
printf("REKVIZITY: -\n");
printf("PRAVIDLA: Hr%c%ci se rozd%cl%c na t%ci t%cmy: KI, KO a KE. Ka%cd%c z t%cm%c mus%c po celou dobu %c%ckat jméno týmu,\n ", aa, cz, ie, ii, rz, yy, zs, yy, yy, uk, ii, rz, ii);
printf("ve kter%cm pr%cv%c je. N%csledn%c se hr%c%ci sna%c%c chytit hr%c%ce jin%cch t%cm%c, proti kter%cm jsou silní, \n", ee, aa, ie, aa, ie, aa, cz, zs, ii, aa, cz, yy, yy, uk, yy);
printf("a t%cm je konvertovat do sv%cho t%cmu. Plat%c, %ce KI jsou siln%c proti KO, KO proti KE a KE proti KI.\n ", ii, ee, yy, ii, zs, ii);
printf("Vyhrajou ti, kte%c%c skon%c%c a jsou co nejm%cn%ckr%ct konvertováni.\n", rz, ii, cz, ii, ee, ie, aa);
printf("Zde pi%cte p%c%ckazy: \n", sz, rz, ii);
	}
...
printf("PRAVIDLA: Zd%crazn%cte, %ce v t%cto h%ce hraje ka%cd%c s%cm za sebe. Ur%cete jeden p%cedm%ct, nap%c. tenisák, \n", uk, ie, zs, ee, rz, zs, yy, aa, cz, rz, ie, rz);
printf("kter%c se stane %cst%cedn%cm p%cedm%ctem hry. Hr%c%ci se po zah%cjen%c hry - vhozen%c tenis%cku do davu - snaží\n ", yy, uu, rz, ii, rz, ie, aa, cz, aa, ii, ii, aa);
...
printf("H%c%cek spo%c%cv%c v tom, %ce ka%cd%c se o to pokou%c%c s%cm za sebe, a tak nastane p%ckná mela.\n", aa, cz, cz, ii, aa, zs, zs, yy, sz, ii, aa, ie);
printf("Zde pi%cte p%c%ckazy: \n", sz, rz, ii);
	}
...
printf("                         sss                                            \n\n");
printf("REKVIZITY: t%c%ck%c velk%c p%cedm%ct (ide%cln%c s obl%cmi stranami, aby se %clov%ck nezranil) -- t%ceba kláda\n", ie, zs, yy, yy, rz, ie, aa, ie, yy, cz, ie, rz);
printf("PRAVIDLA: Rozd%clte hr%c%ce do minim%cln%c t%c%c stejn%c po%cetn%cch t%cm%c. Doprost%ced hern%cho pole položte\n ", ie, aa, cz, aa, ie, rz, ii, ie, cz, yy, yy, uk, rz, ii);
printf("\'talism%cnek\' v podob%c velk%c kl%cdy, %ci jin%cho t%c%ck%cho p%cedm%ctu. N%csledn%c rozd%clte každému týmu\n ", aa, ie, ee, aa, cz, ee, ie, zs, ee, rz, ie, aa, ie, ie);
printf("stanovi%ct%c stejn%c daleko od talism%cnku. C%clem ka%cd%cho t%cmu je dostat talism%cnek do sv%cho stanoviště.\n ", sz, ie, ie, aa, ii, zs, ee, yy, aa, ee);
...
printf("                                                  /____/                /____/   \n\n");
printf("REKVIZITY: -\n");
printf("PRAVIDLA: Ur%cete n%cjak%c hrac%c pole, jako nap%c. louka. Pot%c rozd%clte hr%c%ce do n%ckolika týmů. \n ", cz, ie, ee, ii, rz, ee, ie, aa, cz, ie);
printf("Hra prob%ch%c tak, %ce hr%c%ci r%czn%c chod%c po louce a sna%c%c se navz%cjem zaleh%cvat. V%ct%cz%c poté tým, \n ", ii, aa, zs, aa, cz, uk, ie, ii, zs, ii, aa, aa, ii, ie, ii);
...
printf("domluvit si spole%cn%c aliby. Pot%c zbytek hr%c%c%c po jednom oba vybran%c p%cedvol%c a na%ckne je z n%cjakého\n ", cz, ee, ee, aa, cz, uk, ee, rz, aa, rz, ie);
...
printf("odpov%cdaj%c. C%clem dvou dobrovoln%ck%c je, aby jejich v%cpov%cdi byly co nejv%cce identick%c a sv%cdčili\n ", ii, ii, ii, ii, uk, yy, ie, ii, ee, ie);
...
printf("sehr%cla kr%ctk%c sc%cnky. To se m%c%ce zd%ct n%cro%cn%c, ale sc%cnky stejn%c v%ct%cinou nemaj%c %cádnou úroveň\n", aa, aa, ee, ee, uk, zs, aa, aa, cz, ee, ee, ie, ie, sz, ii, zs);
...
printf("Tak%c dejte pozor, aby se do hry zapojil ka%cd%c a zkuste motivovat introvertn%cj%c%c hr%cče.\n", ee, zs, yy, ie, sz, ii, aa);
printf("ALTERNATIVN%c PRAVIDLA: \n", II);
printf("\t -VYVOL%cVAC%c IMPROVIZACE: Na sc%cn%c je cca. p%cti%clenn%c t%cm, kter%cmu se zad%c herní\n téma", AA, II, ee, ie, ie, cz, yy, yy, ee, aa);
printf("(nap%c. %cernobyl, p%ct minut p%ced v%cbuchem). Ka%cd%c z hr%c%c%c si pak vezme kl%c%cov%c slovo, které\n", rz, CZ, ie, rz, yy, zs, yy, aa, cz, uk, ii, cz, ee);
printf("se vztahuje k t%cmatu, ale kter%c NEZTV%cRŇUJE ve h%ce. N%ckdo by si t%ceba mohl vz%ct slovo\n", ee, ee, AA, rz, ie, rz, ii);
...
printf("kdo je a co d%cl%c. Pokud n%ckter%c hr%c%c na sc%cn%c %cekne n%cjak%c kl%c%cov%c slovo, mus%c ten hráč, koho\n", ie, aa, ie, yy, aa, cz, ee, ie, rz, ie, ee, ii, cz, ee, ii);
printf("je, vstoupit na sc%cnu a vymyslet si pro to d%cvod a %c%cct ho. Pokud je naopak zm%cn%cno kl%cčové\n", ee, uk, rz, ii, ii, ie, ii);
printf("slovo hr%c%ce na sc%cn%c, mus%c ten hr%c%c odej%ct a op%ct pro to vymyslet d%cvod a %c%cct ho. Scénka\n", aa, cz, ee, ie, ii, aa, cz, ii, ie, uk, rz, ii);
...
printf("\t -TLESKAC%c IMPROVIZACE: Na sc%cn%c za%cnou dva lid%c rozehr%cvat sc%cnku a zbyl%c sedí\n", II, ee, ie, cz, ee, aa, ee, ii);
printf("jako publikum. Kdokoliv z publika n%csledn%c m%c%ce tlesknout, sc%cnku zastavit (herci se zmrazí)\n", aa, ie, uk, zs, ee);
printf("a nahradit jednoho z herc%c (toho, kter%c je tam d%cle). Mus%c v%cak rozehr%ct kompletn%c jinou scénku\n", uk, yy, ee, ii, sz, aa, ie);
printf("a zaujmout kompletn%c jinou roli. Pozn.: m%c%ce se hodit pravidlo, %ce se sc%cnka mus%c nechat rozehrát\n", ie, uk, zs, zs, ee, ii);
printf("alespoň n%cjak%c %cas, ať po%c%cd v%cichni netleskaj%c a je vid%ct smysl sc%cnky.\n" , ie, yy, cz, rz, aa, sz, ii, ie, ee);
printf("\t -%cASOV%c IMPROVIZACE: Dva lid%c mus%c sehr%ct tu samou sc%cnku, kterou poprvé\n", CZ, AA, ee, ii, aa, ee);
...
printf("\t -B%cSEŇ: Herci si sednou vedle sebe na stoli%cky a popo%cad%c %c%ck%c ka%cd%c jedno slovo.\n", AA, cz, rz, ie, rz, ii, aa, zs, yy);
printf("Jejich c%clem je vytvo%cit b%cseň, nebo p%c%cb%ch (vyberte p%cedem).\n", ii, rz, aa, rz, ii, ie, rz);
printf("\t -SK%c%cŇ: Vybere se jeden %clov%ck, kter%c p%cedst%cr%c, %ce otev%ce sk%c%cň a vytáhne\n", RZ, II, cz, ie, yy, rz, ii, aa, zs, rz, rz, ii);
...
printf("sna%c%c uhodnout. Kdo ho uhodl, vytahuje ze sk%c%cn%c p%c%c%ctě. \n", zs, ii, rz, ii, ie, rz, ii, sz);
printf("\t -P%cEB%cJEC%c IMPROVIZACE: Jeden %clov%ck za%cne v poli t%cm, %ce n%cco předvede", RZ, II, II, cz, ie, cz, ii, zs, ie);
printf("(nap%c. \nsk%c%cň, auto, zeď...). N%csledn%c dobrovoln%ck z publika tleskne a na jevi%cti p%cedvede něco,", rz, rz, ii, aa, ie, ii, sz, rz);
printf("co to\np%cebije. Potom dal%c%c dobrovoln%ck tleskne a p%cebije to... Takto se vytvo%c%c kask%cda p%ceb%cjec%cch reakcí.\n ", rz, sz, ii, ii, rz, rz, ii, aa, rz, ii, ii);
printf("\t -REKLAMACE: Dva lid%c se v%cij%c do role prodejc%c a jin%c dva do role\n", ee, zs, ii, uk, ii);
printf("nespokojen%cch z%ckazn%ck%c, kte%c%c p%ci%cli reklamovat sv%c zbo%c%c. H%c%cek se schovává v tom,\n", yy, aa, ii, uk, rz, ii, rz, sz, ee, zs, ii, aa, cz);
...
printf("tedy p%cij%ct na to, co reklamuj%c, ale st%cle dodr%covat roli toho, %ce jsou v obchodu a jsou na%ctvaný\n", rz, ii, ii, aa, zs, zs, sz);
printf("z%cklazn%ck. Hra kon%c%c, jakmile reklamuj%cc%c uhodnou reklamovanou věc.\n", aa, ii, cz, ii, ii, ii);
printf("Zde pi%cte p%c%ckazy: \n", sz, rz, ii);
	}
...
printf("PRAVIDLA: Hra se hraje jako vyb%cjen%c akor%ct s t%cm rozd%clem, %ce m%c%cek je tenisák\n", ii, aa, aa, ii, ii, zs, ii, cz);
...
printf("ke stolu maj%c m%ct, av%cak ostatn%c to maj%c prov%cst jen pokud p%ced t%cm %cekne KOMANDO. Ve hře\n", ii, ii, sz, ii, ii, ee, rz, ii, rz);
printf("jsou t%ci polohy rukou:\n", rz);
printf("\t -HOPSANDO: hr%c%ci maj%c ruce ve tvaru pistole a ťukaj%c do stolu \n", aa, cz, ii, ii);
printf("\t -DUTO: hr%c%ci se dot%ckaj%c stolu %cpi%ckami prst%c av%cak ne dlaněmi \n", aa, cz, yy, ii, sz, cz, uk, sz);
...
printf("a ke druh%cmu se postav%c stoli%cka, na kterou se polo%c%c jeden dob%ce uchopitelný\n", ee, ii, cz, zs, ii, rz);
printf("p%cedm%ct (fla%cka s vodou, petangov%c koule aj.). Oba hr%c%ci, kte%c%c maj%c k p%cedmětu\n", rz, ie, sz, aa, aa, cz, rz, ii, ii, rz);
printf("nejbl%c%ce, k n%cmu mus%c m%ct stejn%c daleko. Hr%c%ci nejbl%c%ce ke vhazova%ci se na něj\n", ii, zs, ie, ii, ii, ie, aa, cz, ii, zs, cz);
printf("d%cvaj%c, ostatn%c se mus%c d%cvat sm%crem k p%cedm%ctu. Hra prob%ch%c tak, %ce vhazovač\n", ii, ii, ii, ii, ii, ie, rz, ie, ii, aa, zs);
printf("hod%c minc%c a kdy%c padne pana, pote%ce elektrika, kdy%c ne, tak nepote%ce. Jakmile\n", ii, ii, zs, cz, zs, cz);
printf("te%ce elektrika, mus%c ti, co se d%cvaj%c na minci poslat stisknut%cm ruky signál\n", cz, ii, ii, ii, ii);
printf("ostatn%cm z t%cmu, kte%c%c si ho p%cedaj%c. A%c sign%cl dojde k posledn%cmu %clov%cku, musí\n", ii, yy, rz, ii, rz, ii, zs, aa, ii, cz, ie);
...
printf("se t%cm opa%cn%c. Hra kon%c%c t%cm, %ce se jeden t%cm vyst%c%cd%c na v%cech pozic%cch (jednou nebo vícekrát).\n", yy, cz, ie, cz, ii, ii, zs, yy, rz, ii, aa, sz, ii);
printf("Zde pi%cte p%c%ckazy: \n", sz, rz, ii);
	}
...
printf("PRAVIDLA: Hr%c%ci se rozd%cl%c na dva t%cmy a sednou si proti sob%c ke stolu. Hra probíhá\n", aa, cz, ie, ii, yy, ie);
printf("tak, %ce t%cm, kter%c je na %cad%c, si tajn%c mezi sebou pod stolem pod%c mince a pot%c položí\n", zs, yy, yy, rz, ie, ie, aa, ee);
printf("lokty na st%cl a zav%ce p%csti, aby ne%clo vid%ct, kdo m%c mince. V%cichni najednou n%csledovně\n", uk, rz, ie, sz, ie, aa, sz, aa);
...
printf("pomoc%c zvuku, kter%c vyd%cvaj%c mince p%ci bouchnut%c o stůl.\n", ii, yy, aa, ii, rz, ii);
printf("POZN.: V t%cmu se lid%c hodn%c h%cdaj%c, tak%ce se vyplat%c ur%cit jednoho z%cstupce a jedině on\n", yy, ee, ie, aa, ii, zs, ii, cz, aa);
...
printf("REKVIZITY: provaz, p%cedm%cty, kter%c se lehce daj%c skr%ct na %clověku\n", rz, ie, ee, ii, yy, cz);
printf("PRAVIDLA: Hr%c%ci se rozd%cl%c na dva t%cmy - celn%cky a pa%cer%cky (celn%ck%c je m%cn%c ne%c pašeráků,\n", aa, cz, ie, ii, yy, ii, sz, aa, ii, uk, ee, ie, zs);
printf("pom%cr zhruba 3:2). Provazem se ohrani%c%c kruh s polom%crem cca. 2 metry, kter%c bude p%cedstavovat\n", ie, cz, ii, ie, yy, rz);
printf("zahrani%c%c pro pa%cer%cky. Ur%c%c se je%ct%c %czem%c kolem zahrani%c%c, kter%c p%cedstavuje celnici, a která\n", cz, ii, sz, aa, cz, ii, sz, ie, uu, ii, cz, ii, ee, rz);
...
printf("pa%covan%c p%cedm%ct a onen p%cedm%ct propa%covat do zahrani%c%c. Sta%c%c tedy, aby se %clov%ck i s předmětem\n", sz, yy, rz, ie, rz, ie, sz, cz, ii, cz, ii, cz, ie);
...
printf("nenajde, mus%c se pa%cer%ck vr%ctit zp%ct do mimo celnici a zahrani%c%c. Pokud celn%cci chyt%c pašeráka\n", ii, sz, aa, aa, ie, cz, ii, ii, ii);
...
printf("hry. Smysl t%cto hry spo%c%cv%c v tom, %ce se hr%c%ci spiknou proti jin%cm hr%c%c%cm a hod%c mu několik\n", ee, cz, ii, aa, zs, aa, cz, yy, aa, cz, uk, ii);
...
printf("%clov%cka. Vyslanec p%cijde k %cad%c lid%c, kte%c%c mus%c p%ced sebe nat%chnout obě ruce\n", cz, ie, rz, rz, ie, ii, rz, ii, ii, rz, aa);
printf("dlan%cmi nahoru. Vyslanec pot%c mus%c pl%ccnout t%ci dlan%c z druh%c %cady. Jakmile plácne\n", ie, ee, ii, aa, rz, ie, ee, rz);
printf("t%cet%c, stane se jeho c%clem dob%chnout za svoji %cadu a c%clem pl%cnut%cho se stane se ho\n", rz, ii, ii, ie, rz, ii, aa, ee);
printf("dotknout. Komu se c%cl poda%c%c, ten konvertuje toho druh%cho do sv%c %cady. Hra skončí,\n", ii, rz, ii, ee, ee, rz);
printf("a%c zbyde jen jedna %cada (nebo tak, %ce zbyde jen %clov%ck se dv%cma rukama, kterého\n", zs, rz, zs, cz, ie, ie);
...
printf("kter%cho nen%c %cniku. Na%ct%cst%c p%cil%ct%c vrtuln%ck, ale v n%cm je m%csto pouze na jednoho hr%c%ce. Hráči se\n", ee, ii, uu, sz, ie, ii, rz, ee, aa, ii, ie, ii, aa, cz);
...
printf("POZN. %c.2: Hra m%c dv%c jm%cna - ho%c%cc%c mrakodrap, co%c symbolizuje v%c%ce popsan%c p%c%cb%ch, nebo tramvaj, což \n", cz, aa, ie, ee, rz, ii, ii, zs, yy, sz, yy, rz, ii, ie);
...
printf("Dovnit%c se hod%c m%c%c a hr%c%ci se sna%c%c prohodit m%c%c brankami ostatn%cch. Pokud hr%c%ci n%ckdo prohodí míč\n", rz, ii, ii, cz, aa, cz, zs, ii, ii, cz, ii, aa, cz, ie);
printf("mezi nohama, nebo se hr%c%c narovn%c, ztr%cc%c jednu ruku, a kdy%c nem%c ruku, tak vypad%cv%c. Hr%c%ci nesmí\n", aa, cz, aa, aa, ii, zs, aa, aa, aa, aa, cz);
printf("st%c%clet na lidi t%csn%c vedle sebe, tak%ce vyhr%cvaj%c posledn%c t%ci lidé.\n", rz, ii, ie, ie, zs, aa, ii, ii, rz);
printf("Zde pi%cte p%c%ckazy: \n", sz, rz, ii);
	  }
